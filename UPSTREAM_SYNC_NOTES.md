...
Upstream commit: 2d5c68187a38db0c3bbe4cc18be77c12b0f54727
Behind by:  28266 commits
...
```bash
git fetch origin "chore/upstream-sync-2026-09-26-2d5c681" && git switch "chore/upstream-sync-2026-09-26-2d5c681"
...
git commit
git push --force origin "chore/upstream-sync-2026-09-26-2d5c681"
```
