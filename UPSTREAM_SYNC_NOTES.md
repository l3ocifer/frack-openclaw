...
Upstream commit: 593dba8c1e2a3d6500f544855b62c5c4a4e8048a
Behind by:  27232 commits
...
```bash
git fetch origin "chore/upstream-sync-2026-09-24-593dba8" && git switch "chore/upstream-sync-2026-09-24-593dba8"
...
git commit
git push --force origin "chore/upstream-sync-2026-09-24-593dba8"
```
