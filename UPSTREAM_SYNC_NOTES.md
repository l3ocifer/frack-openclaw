...
Upstream commit: d7111df636966c29e339c1ea4256e0a728e03150
Behind by:  21014 commits
...
```bash
git fetch origin "chore/upstream-sync-2026-09-13-d7111df" && git switch "chore/upstream-sync-2026-09-13-d7111df"
...
git commit
git push --force origin "chore/upstream-sync-2026-09-13-d7111df"
```
