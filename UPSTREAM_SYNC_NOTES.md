...
Upstream commit: a7bbf67b358e8bd961b7c4ebe5d95cff47fbd854
Behind by:  24977 commits
...
```bash
git fetch origin "chore/upstream-sync-2026-09-20-a7bbf67" && git switch "chore/upstream-sync-2026-09-20-a7bbf67"
...
git commit
git push --force origin "chore/upstream-sync-2026-09-20-a7bbf67"
```
