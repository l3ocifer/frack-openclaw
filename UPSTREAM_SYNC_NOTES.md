...
Upstream commit: b47ba1021fff4432404195f893fbb6d6ed728c25
Behind by:  22868 commits
...
```bash
git fetch origin "chore/upstream-sync-2026-09-16-b47ba10" && git switch "chore/upstream-sync-2026-09-16-b47ba10"
...
git commit
git push --force origin "chore/upstream-sync-2026-09-16-b47ba10"
```
