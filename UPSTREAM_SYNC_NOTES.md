...
Upstream commit: 47060d1cef27c69794b68f6652ba183ad65a494d
Behind by:  21765 commits
...
```bash
git fetch origin "chore/upstream-sync-2026-09-14-47060d1" && git switch "chore/upstream-sync-2026-09-14-47060d1"
...
git commit
git push --force origin "chore/upstream-sync-2026-09-14-47060d1"
```
