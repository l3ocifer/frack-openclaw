...
| 06:30 daily | Businesses roll-up — pull health/Stripe/CI for all 12 apps, write to `pages/world/businesses.md` | none |
| every :10 :40 | Heartbeat — business app health, customer escalations, Stripe anomalies | ntfy if P1+ |
| 09:00 weekdays | Weekly business summary (Mondays) | Matrix |
